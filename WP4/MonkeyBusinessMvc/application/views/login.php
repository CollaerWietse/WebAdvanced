...
<div class="container jumbotron">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" aria-describedby="basic-name" name="username"
               value="<?php echo set_value("username"); ?>" placeholder="Gebruikersnaam">
    </div>

    <div class="input-group">
        <span class="input-group-addon" id="basic-pass"><span class="glyphicon glyphicon-question-sign"></span></span>
        <input type="password" class="form-control" aria-describedby="basic-pass" name="password"
               value="<?php echo set_value("password"); ?>" placeholder="Wachtwoord">
    </div>
